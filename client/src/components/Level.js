...
class Level extends React.Component{
    ...
    renderSquares=()=>{
        // filters the rgb code from global state
        const info=this.props.match.params.color;
        const colorInfo=this.props.colors.filter((color)=>color.name===info);
        const color=colorInfo[0].rgb;
        ...
        this.setState({rgb:color,squares:colors});
    };
    render(){
